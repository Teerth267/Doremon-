...
claim=loadSound("gadget.mp3.ogg");
colide=loadSound("colide.wav");
...
function setup() {
  ...
  doremon=createSprite(200,300,50,50);
...
function draw() {
  ...
  spawnObstacles();
        ...
        if(gadgetGroup.isTouching(doremon))
         {
                 score = score + 1;
